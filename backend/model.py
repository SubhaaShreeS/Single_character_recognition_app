...
# 1. Load and preprocess custom lowercase alphabet dataset
# White digit on black = correct format
# If average pixel value > 127, assume it's black digit on white and invert
def preprocess_custom_image(img_path):
    img = Image.open(img_path).convert('L')  # Convert to grayscale
    img = img.resize((28, 28), Image.LANCZOS)

    img_array = np.array(img)
    # If background is light (white), invert it
...
print("\n✅ Final alphabet model saved as 'alphabets_model.keras'")
'''
